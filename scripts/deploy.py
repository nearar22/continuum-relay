"""Deploy the Continuum Relay contract to Bradbury. Polls manually via the
patched SDK decode so status code 14 does not crash."""
import json
import os
import sys
import time
...
def main():
    ...
    print("Deploying continuum_relay_contract.py (", len(code), "bytes )...")
